...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">SMS Notifications &nbsp; &nbsp; &nbsp;
      ...
      <a class="nav-tab <?php if( $data['tab'] == 'networks' ) { ?>nav-tab-active<?php } ?>" href="?page=clockwork_sms_notifications&amp;tab=networks">Networks</a>
      ...
      <a class="nav-tab <?php if( $data['tab'] == 'upgrade' ) { ?>nav-tab-active<?php } ?>" href="?page=clockwork_sms_notifications&amp;tab=upgrade">Upgrade</a>
    </h2>
