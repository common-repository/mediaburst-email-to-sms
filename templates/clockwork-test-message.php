...
<div class="wrap">
  <div class="left-content">
    ...
    <p>You should now have received a text message to <?php print htmlentities($_GET['to']); ?>. If you have not received this, copy and paste the contents of the textbox below into a support request.</p>
  ...
  <div class="right-content">
    <div class="innerbox">
      ...
      <p><input type="text" size="14" maxlength="14" class="clockwork_number_field" name="to" value="" placeholder="447700900123"> <button type="submit" class="button">Test</a></p>
      </form>
    </div>
  </div>
</div>
